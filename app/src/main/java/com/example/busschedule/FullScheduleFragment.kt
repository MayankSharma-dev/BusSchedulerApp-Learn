...
class FullScheduleFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /**Finally, in FullScheduleFragment.kt, the busStopAdapter should be updated when you call collect() on the query results.
         * Because fullSchedule() is a suspend function, it needs to be called from a coroutine. */
